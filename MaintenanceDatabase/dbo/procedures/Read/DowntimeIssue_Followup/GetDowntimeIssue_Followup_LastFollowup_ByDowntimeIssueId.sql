CREATE PROCEDURE [dbo].[GetDowntimeIssue_Followup_LastFollowup_ByDowntimeIssueId]
	@DowntimeIssueId int
AS
	SELECT 
    ...
    WHERE [DowntimeIssues].[Id] = @DowntimeIssueId
    AND [DowntimeIssues_Followups].SupervisorFollowUp is null
    ORDER BY [DowntimeIssues_Followups].FollowUpRequest DESC
 RETURN 0
