CREATE PROCEDURE [dbo].GetDowntimeIssue_Followup_ByDowntimeIssue_FollowUpId
	@DowntimeIssue_FollowUpId int
AS
	SELECT 
    ...
    WHERE [DowntimeIssues_Followups].[Id] = @DowntimeIssue_FollowUpId
